...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
MVI architecture implementation basic and needs for iOS framework to create valid applications for swift 5.0
                   DESC
  ...
  s.source       = { :git => "https://github.com/droideveloper/MVICocoa.git", :branch => 'master' }
